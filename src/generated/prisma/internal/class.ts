...
/**
  ...
  /**
   * `prisma.detailLesson`: Exposes CRUD operations for the **DetailLesson** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more DetailLessons
    * const detailLessons = await prisma.detailLesson.findMany()
    * ```
    */
  get detailLesson(): Prisma.DetailLessonDelegate<ExtArgs, { omit: OmitOpts }>;
